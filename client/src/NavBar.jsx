  ...
  return(
    <div className="TopContainer">
      <div className='NavBar'>
        <div className='button NavButton' onClick={()=>{setDisplay('Homepage')}} >
        <div className='imgFrame'>
            <img className='HomepageIcon' src='https://s3-media0.fl.yelpcdn.com/bphoto/f02PpF1ofSMdITW2Y_z6tQ/o.jpg'></img>
          </div>
        </div>
        <div className='button NavButton' onClick={()=>{setDisplay('Nutrition')}} >
        <div className='imgFrame'>
        ...
        <div className='button NavButton' onClick={()=>{setDisplay('Lifts')}} >
          <div className='imgFrame'>
